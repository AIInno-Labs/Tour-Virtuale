...
window.TOUR = {
  ...
  scenes: [
    ...
    { id: "08pineta2", chapter: "pine", night: { positions: { "09torre1": { yaw: -48.3, pitch: 6.6 }, "06percorsotorre3": { yaw: -136.5, pitch: 8.3 } }, view: { yaw: -48.3, pitch: 6.6 } }, name: "Pine Grove 2", nameIt: "Pineta 2",
      view: { yaw: -92, pitch: -7 },
    ...
    { id: "28antipasti2", chapter: "courtyard", night: { positions: { "39tratturo1": { yaw: -175.7, pitch: 10.7 }, "25corte2": { yaw: 102.0, pitch: 17.6 }, "24corte1": { yaw: 34.8, pitch: 12.2 }, "29antipasti3": { yaw: -47.7, pitch: 21.9 } }, view: { yaw: -175.7, pitch: 10.7 } }, name: "Appetizers 2", nameIt: "Antipasti 2",
      view: { yaw: 58, pitch: -6 },
    ...
    { id: "29antipasti3", chapter: "courtyard", night: { positions: { "30spalliera2": { yaw: 18.1, pitch: 10.8 }, "28antipasti2": { yaw: 101.5, pitch: 17.6 }, "39tratturo1": { yaw: 168.7, pitch: 9.3 } }, view: { yaw: 18.1, pitch: 10.8 } }, name: "Appetizers 3", nameIt: "Antipasti 3",
