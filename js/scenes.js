...
window.TOUR = {
  ...
  scenes: [
    ...
    { id: "04percorsotorre1", chapter: "path", night: { positions: { "05percorsotorre2": { yaw: -69.8, pitch: -2.1 } }, view: { yaw: -69.8, pitch: -2.1 } }, name: "Tower Path 1", nameIt: "Percorso Torre 1",
      view: { yaw: -21, pitch: -7 },
      links: [{ to: "03ingressotorre", yaw: -155, pitch: 25 }, { to: "02parcheggio", yaw: 113, pitch: 9 }, { to: "05percorsotorre2", yaw: -28, pitch: 5 }] },
    { id: "05percorsotorre2", chapter: "path", night: { positions: { "06percorsotorre3": { yaw: 0.0, pitch: 0.0 }, "04percorsotorre1": { yaw: 175.7, pitch: 19.7 } }, view: { yaw: 0.0, pitch: 0.0 } }, name: "Tower Path 2", nameIt: "Percorso Torre 2",
      view: { yaw: -137, pitch: -7 },
      links: [{ to: "04percorsotorre1", yaw: 96, pitch: 26 }, { to: "06percorsotorre3", yaw: -132, pitch: 1 }] },
    { id: "06percorsotorre3", chapter: "path", night: { positions: { "05percorsotorre2": { yaw: 177.7, pitch: 16.4 }, "08pineta2": { yaw: 71.4, pitch: 9.3 }, "09torre1": { yaw: -5.4, pitch: 9.3 } }, view: { yaw: 177.7, pitch: 16.4 } }, name: "Tower Path 3", nameIt: "Percorso Torre 3",
      view: { yaw: 3, pitch: -16 },
    ...
    { id: "08pineta2", chapter: "pine", night: { positions: { "09torre1": { yaw: -48.3, pitch: 6.6 }, "06percorsotorre3": { yaw: -136.5, pitch: 8.3 } }, view: { yaw: -48.3, pitch: 6.6 }, name: "Pine Grove 1", nameIt: "Pineta 1" }, name: "Pine Grove 2", nameIt: "Pineta 2",
      view: { yaw: -92, pitch: -7 },
      links: [{ to: "07pineta1", yaw: -110, pitch: 11 }, { to: "05percorsotorre2", yaw: -180, pitch: 8 }, { to: "10torre2", yaw: -76, pitch: 6 }] },
    { id: "09torre1", chapter: "tower", night: { positions: { "06percorsotorre3": { yaw: -172.8, pitch: 11.6 }, "08pineta2": { yaw: 128.6, pitch: 9.8 }, "torre2b": { yaw: -37, pitch: 6 } }, view: { yaw: -172.8, pitch: 11.6 } }, name: "Tower 1", nameIt: "Torre 1",
    ...
    { id: "torre2b", chapter: "tower", nightOnly: true, night: { positions: { "10torre2": { yaw: 69.9, pitch: 9.8 }, "09torre1": { yaw: 165.9, pitch: 10.1 } }, view: { yaw: 69.9, pitch: 9.8 } }, name: "Tower 2", nameIt: "Torre 2",
      view: { yaw: 0, pitch: 0 },
      links: [{ to: "10torre2", yaw: 69.9, pitch: 9.8 }, { to: "09torre1", yaw: 165.9, pitch: 10.1 }] },
    { id: "10torre2", chapter: "tower", night: { positions: { "09torre1": { yaw: 120.0, pitch: 5.0 }, "11torre3": { yaw: -5.3, pitch: 14.9 }, "torre2b": { yaw: -149.0, pitch: -1.4 } }, view: { yaw: 120.0, pitch: 5.0 }, name: "Tower 3", nameIt: "Torre 3" }, name: "Tower 2", nameIt: "Torre 2",
      view: { yaw: 8, pitch: -19 },
      links: [{ to: "11torre3", yaw: -152, pitch: 33 }, { to: "07pineta1", yaw: -7, pitch: 4 }] },
    { id: "11torre3", chapter: "tower", night: { positions: {  }, name: "Tower 4", nameIt: "Torre 4" }, name: "Tower 3", nameIt: "Torre 3",
      view: { yaw: 12, pitch: 3 },
    ...
    { id: "13ingressoroma", chapter: "entrance", night: { positions: { "14atrio1": { yaw: 7.3, pitch: 5.3 } }, view: { yaw: 7.3, pitch: 5.3 } }, name: "Roma Entrance", nameIt: "Ingresso Roma",
      view: { yaw: 10, pitch: -19 },
      links: [{ to: "12torredrone", yaw: -95, pitch: -26 }, { to: "14atrio1", yaw: 5, pitch: 12 }] },
    { id: "14atrio1", chapter: "entrance", night: { positions: { "13ingressoroma": { yaw: -135.3, pitch: 12.2 }, "15giardino1": { yaw: 136.9, pitch: 14.5 }, "17quercia1": { yaw: 47.2, pitch: 5.5 } }, view: { yaw: -135.3, pitch: 12.2 } }, name: "Atrium", nameIt: "Atrio",
      view: { yaw: 50, pitch: -3 },
      links: [{ to: "15giardino1", yaw: 83, pitch: 13 }, { to: "13ingressoroma", yaw: -160, pitch: 14 }, { to: "17quercia1", yaw: 17, pitch: 13 }] },
    { id: "15giardino1", chapter: "garden", night: { positions: { "16giardino2": { yaw: 11.9, pitch: 9.1 }, "14atrio1": { yaw: -82.1, pitch: 14.5 }, "13ingressoroma": { yaw: -144.5, pitch: 7.5 } }, view: { yaw: 11.9, pitch: 9.1 } }, name: "Garden 1", nameIt: "Giardino 1",
      view: { yaw: 45, pitch: -12 },
      links: [{ to: "16giardino2", yaw: 97, pitch: 6 }, { to: "14atrio1", yaw: -5, pitch: 3 }] },
    { id: "16giardino2", chapter: "garden", night: { positions: { "23spalliera1": { yaw: 172.6, pitch: 14.1 }, "17quercia1": { yaw: 97.9, pitch: 7.0 }, "15giardino1": { yaw: 26.2, pitch: 1.9 } }, view: { yaw: 172.6, pitch: 14.1 } }, name: "Garden 2", nameIt: "Giardino 2",
    ...
    { id: "17quercia1", chapter: "garden", night: { positions: { "14atrio1": { yaw: 25.6, pitch: 9.3 }, "16giardino2": { yaw: -29.9, pitch: 13.3 }, "18quercia2": { yaw: 141.3, pitch: 15.8 } }, view: { yaw: 25.6, pitch: 9.3 } }, name: "Oak Tree 1", nameIt: "Quercia 1",
      view: { yaw: 16, pitch: -12 },
      links: [{ to: "18quercia2", yaw: -24, pitch: 8 }, { to: "16giardino2", yaw: 51, pitch: 11 }, { to: "14atrio1", yaw: -179, pitch: 12 }] },
    { id: "18quercia2", chapter: "garden", night: { positions: { "17quercia1": { yaw: 59.8, pitch: 9.0 }, "23spalliera1": { yaw: 5.6, pitch: 11.2 }, "24corte1": { yaw: -45.0, pitch: 10.3 }, "31scaladx": { yaw: -96.4, pitch: -13.5 }, "32scalasx": { yaw: 113.4, pitch: -14.0 }, "19sala1": { yaw: -174.8, pitch: 12.2 } }, view: { yaw: 59.8, pitch: 9.0 } }, name: "Oak Tree 2", nameIt: "Quercia 2",
    ...
    { id: "19sala1", chapter: "halls", night: { positions: { "20sala2": { yaw: 4.9, pitch: 13.9 }, "18quercia2": { yaw: 175.8, pitch: 22.3 } }, view: { yaw: 4.9, pitch: 13.9 } }, name: "Hall 1", nameIt: "Sala 1",
      view: { yaw: 3, pitch: 10 },
      links: [{ to: "18quercia2", yaw: -180, pitch: 32 }, { to: "20sala2", yaw: 5, pitch: 26 }] },
    { id: "20sala2", chapter: "halls", night: { positions: { "21sala3": { yaw: 3.9, pitch: 16.4 }, "23sala5": { yaw: -84.7, pitch: 1.2 }, "22sala4": { yaw: 91.7, pitch: -1.1 }, "19sala1": { yaw: -178, pitch: 8 } }, view: { yaw: 3.9, pitch: 16.4 } }, name: "Hall 2", nameIt: "Sala 2",
      view: { yaw: 2, pitch: -6 },
      links: [{ to: "23sala5", yaw: -2, pitch: 22 }, { to: "21sala3", yaw: 62, pitch: 19 }, { to: "19sala1", yaw: 179, pitch: 10 }, { to: "22sala4", yaw: -68, pitch: 18 }] },
    { id: "21sala3", chapter: "halls", night: { positions: { "20sala2": { yaw: -174.1, pitch: 18.0 } }, view: { yaw: -174.1, pitch: 18.0 } }, name: "Hall 3", nameIt: "Sala 3",
      view: { yaw: 4, pitch: 3 },
      links: [{ to: "20sala2", yaw: 1, pitch: 14 }] },
    { id: "22sala4", chapter: "halls", night: { positions: { "20sala2": { yaw: -174.7, pitch: 14.7 } }, view: { yaw: -174.7, pitch: 14.7 } }, name: "Hall 4", nameIt: "Sala 4",
      view: { yaw: 179, pitch: -4 },
      links: [{ to: "20sala2", yaw: 161, pitch: 15 }] },
    { id: "23sala5", chapter: "halls", night: { positions: { "20sala2": { yaw: -1.0, pitch: 9.3 } }, view: { yaw: -1.0, pitch: 9.3 } }, name: "Hall 5", nameIt: "Sala 5",
      view: { yaw: -166, pitch: 0 },
      links: [{ to: "20sala2", yaw: -166, pitch: 18 }, { to: "21sala3", yaw: 152, pitch: 14 }, { to: "22sala4", yaw: -124, pitch: 13 }] },
    { id: "23spalliera1", chapter: "courtyard", night: { positions: { "30spalliera2": { yaw: -101.6, pitch: 9.5 }, "16giardino2": { yaw: 84.2, pitch: 10.0 }, "18quercia2": { yaw: 176.6, pitch: -0.5 } }, view: { yaw: -101.6, pitch: 9.5 } }, name: "Trellis Walk 1", nameIt: "Spalliera 1",
      view: { yaw: 10, pitch: -14 },
      links: [{ to: "18quercia2", yaw: 11, pitch: 5 }, { to: "16giardino2", yaw: -70, pitch: 7 }, { to: "30spalliera2", yaw: 86, pitch: 6 }] },
    { id: "24corte1", chapter: "courtyard", night: { positions: { "18quercia2": { yaw: 4.0, pitch: 12.0 }, "28antipasti2": { yaw: 161.7, pitch: 12.0 }, "25corte2": { yaw: 111.3, pitch: 8.4 } }, view: { yaw: 4.0, pitch: 12.0 } }, name: "Courtyard 1", nameIt: "Corte 1",
      view: { yaw: -48, pitch: 2 },
      links: [{ to: "18quercia2", yaw: -97, pitch: 10 }, { to: "25corte2", yaw: -8, pitch: 20 }, { to: "27antipasti1", yaw: 45, pitch: 12 }] },
    { id: "25corte2", chapter: "courtyard", night: { positions: { "26corte3": { yaw: -172.5, pitch: 0.6 }, "28antipasti2": { yaw: -60.5, pitch: 19.5 }, "24corte1": { yaw: 5.2, pitch: 11.3 } }, view: { yaw: -172.5, pitch: 0.6 } }, name: "Courtyard 2", nameIt: "Corte 2",
      view: { yaw: -91, pitch: 7 },
      links: [{ to: "24corte1", yaw: -81, pitch: 12 }, { to: "26corte3", yaw: 85, pitch: 0 }, { to: "27antipasti1", yaw: -137, pitch: 9 }] },
    { id: "26corte3", chapter: "courtyard", night: { positions: { "25corte2": { yaw: 0.6, pitch: -1.7 } }, view: { yaw: 0.6, pitch: -1.7 } }, name: "Courtyard 3", nameIt: "Corte 3",
    ...
    { id: "28antipasti2", chapter: "courtyard", night: { positions: { "39tratturo1": { yaw: -175.7, pitch: 10.7 }, "25corte2": { yaw: 102.0, pitch: 17.6 }, "24corte1": { yaw: 34.8, pitch: 12.2 }, "29antipasti3": { yaw: -47.7, pitch: 21.9 } }, view: { yaw: -175.7, pitch: 10.7 }, name: "Appetizers 1", nameIt: "Antipasti 1" }, name: "Appetizers 2", nameIt: "Antipasti 2",
      view: { yaw: 58, pitch: -6 },
    ...
    { id: "29antipasti3", chapter: "courtyard", night: { positions: { "30spalliera2": { yaw: 18.1, pitch: 10.8 }, "28antipasti2": { yaw: 101.5, pitch: 17.6 }, "39tratturo1": { yaw: 168.7, pitch: 9.3 } }, view: { yaw: 18.1, pitch: 10.8 }, name: "Appetizers 2", nameIt: "Antipasti 2" }, name: "Appetizers 3", nameIt: "Antipasti 3",
    ...
    { id: "30spalliera2", chapter: "courtyard", night: { positions: { "29antipasti3": { yaw: -10.6, pitch: 2.7 }, "23spalliera1": { yaw: -159.7, pitch: 5.0 } }, view: { yaw: -10.6, pitch: 2.7 } }, name: "Trellis Walk 2", nameIt: "Spalliera 2",
      view: { yaw: -30, pitch: -1 },
      links: [{ to: "29antipasti3", yaw: 51, pitch: 5 }, { to: "23spalliera1", yaw: -77, pitch: 15 }, { to: "18quercia2", yaw: -54, pitch: -6 }] },
    { id: "31scaladx", chapter: "terraces", night: { positions: { "18quercia2": { yaw: 14.2, pitch: 34.0 }, "33terrazza1": { yaw: -177.4, pitch: 9.7 }, "37terrazza4": { yaw: 100.0, pitch: 10.6 } }, view: { yaw: 14.2, pitch: 34.0 } }, name: "Right Staircase", nameIt: "Scala destra",
      view: { yaw: 33, pitch: 4 },
      links: [{ to: "18quercia2", yaw: -85, pitch: 35 }, { to: "33terrazza1", yaw: 76, pitch: 10 }, { to: "37terrazza4", yaw: -2, pitch: 11 }] },
    { id: "32scalasx", chapter: "terraces", night: { positions: { "35terrazza3": { yaw: -86.2, pitch: 12.8 }, "37terrazza4": { yaw: 4.2, pitch: 14.4 }, "18quercia2": { yaw: 96.5, pitch: 32.1 } }, view: { yaw: -86.2, pitch: 12.8 } }, name: "Left Staircase", nameIt: "Scala sinistra",
      view: { yaw: 3, pitch: 7 },
      links: [{ to: "18quercia2", yaw: 104, pitch: 32 }, { to: "37terrazza4", yaw: 20, pitch: 11 }, { to: "35terrazza3", yaw: -67, pitch: 12 }] },
    { id: "33terrazza1", chapter: "terraces", night: { positions: { "34terrazza2": { yaw: 104.7, pitch: 13.6 }, "31scaladx": { yaw: 6.1, pitch: 8.9 } }, view: { yaw: 104.7, pitch: 13.6 } }, name: "Terrace 1", nameIt: "Terrazza 1",
      view: { yaw: 0, pitch: 0 },
      links: [{ to: "31scaladx", yaw: -39, pitch: 9 }, { to: "34terrazza2", yaw: 32, pitch: 11 }, { to: "26corte3", yaw: -143, pitch: 33 }] },
    { id: "34terrazza2", chapter: "terraces", night: { positions: { "35terrazza3": { yaw: 74.3, pitch: 12.9 }, "33terrazza1": { yaw: -93.3, pitch: 9.1 }, "38terrazza5": { yaw: 0.4, pitch: 15.9 } }, view: { yaw: 74.3, pitch: 12.9 } }, name: "Terrace 2", nameIt: "Terrazza 2",
      view: { yaw: 2, pitch: 12 },
      links: [{ to: "38terrazza5", yaw: -2, pitch: 14 }, { to: "33terrazza1", yaw: -122, pitch: 10 }, { to: "35terrazza3", yaw: 102, pitch: 13 }] },
    { id: "35terrazza3", chapter: "terraces", night: { positions: { "32scalasx": { yaw: 20.6, pitch: 7.2 }, "34terrazza2": { yaw: -79.3, pitch: 13.4 } }, view: { yaw: 20.6, pitch: 7.2 } }, name: "Terrace 3", nameIt: "Terrazza 3",
      view: { yaw: 2, pitch: 3 },
      links: [{ to: "32scalasx", yaw: 51, pitch: 9 }, { to: "34terrazza2", yaw: -49, pitch: 10 }] },
    { id: "37terrazza4", chapter: "terraces", night: { positions: { "32scalasx": { yaw: 89.0, pitch: 16.2 }, "31scaladx": { yaw: -95.7, pitch: 14.5 }, "38terrazza5": { yaw: 174.5, pitch: 24.1 } }, view: { yaw: 89.0, pitch: 16.2 } }, name: "Terrace 4", nameIt: "Terrazza 4",
    ...
    { id: "38terrazza5", chapter: "terraces", night: { positions: { "37terrazza4": { yaw: -0.6, pitch: 13.8 }, "34terrazza2": { yaw: -172.7, pitch: 14.5 } }, view: { yaw: -0.6, pitch: 13.8 } }, name: "Terrace 5", nameIt: "Terrazza 5",
      view: { yaw: 2, pitch: -1 },
    ...
    { id: "39tratturo1", chapter: "trail", night: { positions: { "40tratturo2": { yaw: -179.4, pitch: 11.7 }, "28antipasti2": { yaw: 7.4, pitch: 11.9 } }, view: { yaw: -179.4, pitch: 11.7 } }, name: "Drover's Trail 1", nameIt: "Tratturo 1",
      view: { yaw: 4, pitch: -5 },
      links: [{ to: "40tratturo2", yaw: 165, pitch: 0 }, { to: "28antipasti2", yaw: 7, pitch: 23 }] },
    { id: "40tratturo2", chapter: "trail", night: { positions: { "39tratturo1": { yaw: 4.2, pitch: 12.9 }, "tratturo3b": { yaw: 129.6, pitch: -5.5 } }, view: { yaw: 4.2, pitch: 12.9 } }, name: "Drover's Trail 2", nameIt: "Tratturo 2",
    ...
    { id: "tratturo3b", chapter: "trail", nightOnly: true, night: { positions: { "40tratturo2": { yaw: -7.7, pitch: 5.3 }, "41tratturo3": { yaw: -176.8, pitch: -11.2 } }, view: { yaw: -7.7, pitch: 5.3 } }, name: "Drover's Trail 3", nameIt: "Tratturo 3",
      view: { yaw: 0, pitch: 0 },
      links: [{ to: "40tratturo2", yaw: -7.7, pitch: 5.3 }, { to: "41tratturo3", yaw: -176.8, pitch: -11.2 }] },
    { id: "41tratturo3", chapter: "trail", night: { positions: { "42tratturo3": { yaw: -160.5, pitch: -15.2 }, "tratturo3b": { yaw: 18.9, pitch: 10.2 } }, view: { yaw: -160.5, pitch: -15.2 }, name: "Drover's Trail 4", nameIt: "Tratturo 4" }, name: "Drover's Trail 3", nameIt: "Tratturo 3",
      view: { yaw: 141, pitch: 24 },
      links: [{ to: "40tratturo2", yaw: 177, pitch: 17 }, { to: "42tratturo3", yaw: -13, pitch: -7 }] },
    { id: "42tratturo3", chapter: "trail", night: { positions: { "04percorsotorre1": { yaw: 167.2, pitch: -9.2 }, "41tratturo3": { yaw: 1.6, pitch: -1.8 } }, view: { yaw: 167.2, pitch: -9.2 }, name: "Drover's Trail 5", nameIt: "Tratturo 5" }, name: "Drover's Trail 4", nameIt: "Tratturo 4",
