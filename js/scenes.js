 ...
 *   links     hotspots that walk to another scene: { to, yaw, pitch }
...
window.TOUR = {
  ...
  scenes: [
    ...
    { id: "18quercia2", chapter: "garden", name: "Oak Tree 2", nameIt: "Quercia 2",
      ...
      gallery: { folder: "gallery/18quercia2", count: 10, hotspot: { yaw: 168, pitch: 4 } } },
    ...
    { id: "20sala2", chapter: "halls", name: "Hall 2", nameIt: "Sala 2",
      ...
      gallery: { folder: "gallery/20sala2", count: 10, hotspot: { yaw: -19, pitch: 21 } } },
    ...
    { id: "24corte1", chapter: "courtyard", name: "Courtyard 1", nameIt: "Corte 1",
      ...
      gallery: { folder: "gallery/24corte1", count: 10, hotspot: { yaw: -74, pitch: 3 } } },
    ...
    { id: "29antipasti3", chapter: "courtyard", name: "Appetizers 3", nameIt: "Antipasti 3",
      ...
      gallery: { folder: "gallery/29antipasti3", count: 10, hotspot: { yaw: 154, pitch: 25 } } },
    ...
    { id: "34terrazza2", chapter: "terraces", name: "Terrace 2", nameIt: "Terrazza 2",
      view: { yaw: 2, pitch: 12 },
      links: [{ to: "36terrazza3", yaw: -2, pitch: 14 }, { to: "33terrazza1", yaw: -122, pitch: 10 }, { to: "35terrazza3", yaw: 102, pitch: 13 }] },
